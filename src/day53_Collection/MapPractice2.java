...
public class MapPractice2 {
    ...
    public static void main(String[] args) {
        ...
        // verify
        boolean b1 = countries.get("Kurdistan").equals("Amed");

        boolean b2 = countries.containsValue("Amed");
        ...
        // find out which country capital is moscow
