...
public class StringMethods3 {
    ...
    public static void main(String[] args) {
        ...
        sentence = sentence.replace("Java", "Pyhthon"); // "Pyhton is fun, Pyhton is cool"
        ...
        // OR --->   essay = essay.replace("20", "21");

        System.out.println(essay);

        System.out.println("\n--------------------\t-----------------------\n");

        String s = "I Like C++, C++ is very cool";
        s = s.replace("C++", "Java");
        ...
        //  		replaceFirst(OldValue, newValue):	first occured old valie with given new value.
        System.out.println(r);

        System.out.println("\n--------------------\t-----------------------\n");

        String t = "I Like Pyhton, Java is very cool";
        t = t.replaceFirst("Pyhton", "Java").replaceFirst("Java ", "C# ");
        ...
        String result = name.substring(name.lastIndexOf("J"));
