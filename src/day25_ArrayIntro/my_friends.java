...
/*
        System.out.println("How many you have friends?");
        int numbers = scan.nextInt();


        String[] fNames = new String[numbers];
        String[] lNames = new String[numbers];
...
/*
    ...
    how many friends you have?      5, 4, 3, doesn't matter

    String[] frst name  = new String[5]
    String[] last name = new String[5]
